        ...
        <div className="container relative z-30 px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl">
              Bekijk de indrukwekkende resultaten die mijn klanten hebben
              bereikt door toewijding, hard werk en professionele begeleiding.
            </p>
            <Button
              size="lg"
              className="bg-red-500 hover:bg-red-600 text-white"
            >
              Begin Jouw Transformatie
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div className="bg-black rounded-lg overflow-hidden border border-white/10">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-2">
                  Mark | 12 Weken Transformatie
                </h3>
                <p className="text-white/70 mb-4">
                  Doel: Gewichtsverlies & Spieropbouw
                </p>
                <div className="mb-6">
                ...
                <p className="text-white/80 mb-6">
                  "Ik had nooit gedacht dat ik in 12 weken zo'n transformatie
                  kon bereiken. De combinatie van persoonlijke training en
                  voedingsbegeleiding heeft echt het verschil gemaakt. Ik voel
                  me sterker, energieker en zelfverzekerder dan ooit."
                </p>
            ...
            <div className="bg-black rounded-lg overflow-hidden border border-white/10">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-2">
                  Thomas | 16 Weken Transformatie
                </h3>
                <p className="text-white/70 mb-4">
                  Doel: Spieropbouw & Definitie
                </p>
                <div className="mb-6">
                  <div className="flex items-center gap-4 mb-2">
                    <span className="font-bold">Voor:</span>
                ...
                <p className="text-white/80 mb-6">
                  ...
                  eindelijk de resultaten te bereiken waar ik naar streefde. De
                  kennis en motivatie die ik heb gekregen zijn onbetaalbaar."
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-zinc-900 px-3 py-1 rounded-full text-sm">
                    Personal Training
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-black rounded-lg overflow-hidden border border-white/10">
              ...
              <div className="p-8">
                ...
                <p className="text-white/80 mb-6">
                  ...
                  voor mezelf vrij te maken. Het flexibele trainingsschema en de
                  praktische voedingstips hebben me geholpen om mijn doelen te
                  bereiken zonder mijn drukke leven te verstoren. Ik voel me nu
                  energieker en kan beter bijhouden met mijn kinderen!"
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-zinc-900 px-3 py-1 rounded-full text-sm">
                    HIIT Training
            ...
            <div className="bg-black rounded-lg overflow-hidden border border-white/10">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-2">
                  Sander | 24 Weken Transformatie
                </h3>
                <p className="text-white/70 mb-4">
                  Doel: Totale Lichaamsverandering
                </p>
                <div className="mb-6">
                  <div className="flex items-center gap-4 mb-2">
                    <span className="font-bold">Voor:</span>
                ...
                <p className="text-white/80 mb-6">
                  "Na jaren van jojo-diëten en inconsistente training besloot ik
                  het serieus aan te pakken. De holistische aanpak van Mind Over
                  Muscle heeft me niet alleen fysiek getransformeerd, maar ook
                  mijn mindset veranderd. Ik heb geleerd hoe ik gezonde
                  gewoontes kan onderhouden voor de lange termijn."
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-zinc-900 px-3 py-1 rounded-full text-sm">
                    Personal Training
            ...
            <div className="bg-zinc-950 p-8 rounded-lg border border-white/10">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Bouwde 8 kg spiermassa in 6 maanden
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-950 p-8 rounded-lg border border-white/10">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">
                    Bereikte 18% lichaamsvet van 32%
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container relative z-10 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
              Jouw transformatieverhaal kan hier beginnen. Neem vandaag nog
              contact op voor een gratis consultatie en ontdek hoe ik je kan
              helpen je doelen te bereiken.
            </p>
